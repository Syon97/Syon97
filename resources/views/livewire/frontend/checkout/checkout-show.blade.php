                ...
                <div class="col-md-12 mb-4">
                    <div class="shadow bg-white p-3">
                        <h4 class="text-primary">
                            Item Total Amount :
                            <span class="float-end">RM {{ $this->totalProductAmount }}.00</span>
                        </h4>
                        <hr>
                        <small>* Items will be delivered in 2 - 4 days.</small>
                    </div>
                </div>
                        ...
                        <hr>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" wire:model.defer="pincode" id="pincode" class="form-control" placeholder="Enter Postcode" />
...
@push('scripts')
    ...
    <script src="https://www.paypal.com/sdk/js?client-id=AYVhmTdNmRE1LMJY0TriyLBK8ekHI9vsAMieNnfSUwpFv391VHBWxyYHVg-X5nu9d6-l376leh_mwxU3&currency=USD"></script>
    <script>
        paypal.Buttons({
            onClick: function()  {
