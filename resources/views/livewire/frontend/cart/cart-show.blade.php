                            ...
                            <div class="cart-item">
                                <div class="row">
                                    ...
                                    <div class="col-md-1 my-auto">
                                        <label class="price">RM {{ $cartItem->product->selling_price }}.00</label>
                                    </div>
                                    ...
                                    <div class="col-md-1 my-auto">
                                        <label class="price">RM {{ $cartItem->product->selling_price * $cartItem->quantity }}.00</label>
            ...
            <div class="row">
                ...
                <div class="col-md-4 mt-3">
                    <div class="shadow-sm bg-white p-3">
                        <h4>Total:
                            <span class="float-end">RM {{ $totalPrice }}.00</span>
                        </h4>
                        <hr>
