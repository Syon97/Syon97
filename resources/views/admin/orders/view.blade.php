            ...
            <div class="card-header">
                <h3>Orders
                    ...
                    <a href="{{ url('admin/invoice/'.$order->id.'/mail') }}" class="btn btn-info btn-sm float-end mx-1">
                        <span class="fa fa-envelope"></span> Send Invoice via Email
                    </a>
                </h3>
            </div>          
                <div class="card-body">
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td width="12%" class="fw-bold">RM {{ $orderItem->quantity * $orderItem->price}}</td>
                                    @php
                                ...
                                @endforeach
                                <tr>
                                    <td colspan="5" class="fw-bold"><h3>Total Amount: </h3></td>
